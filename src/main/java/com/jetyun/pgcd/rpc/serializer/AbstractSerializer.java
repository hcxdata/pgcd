...
public abstract class AbstractSerializer implements Serializer {
	...
	public boolean canSerialize(Class clazz, Class jsonClazz) {
		...
		for (int i = 0; i < serializableClasses.length; i++) {
			...
			if (clazz == serializableClasses[i]
					|| serializableClasses[i].isAssignableFrom(clazz)) {
				canJava = true;
			}
		}
	...
	public void object2Json(Object obj, JSONObject json)
			throws IllegalArgumentException, IllegalAccessException,
			InvocationTargetException, JSONException {
		SerializerUtil.object2Json(obj, json);
	}

	public void json2Object(JSONObject json, Object obj)
			throws IllegalArgumentException, JSONException,
			IllegalAccessException, InvocationTargetException, ParseException {
		SerializerUtil.json2Object(json, obj);
	}

	public void object2Json(Object obj, JSONObject json, String[] args,
	...
	public void json2Object(JSONObject json, Object obj, String[] args,
			String format) throws IllegalArgumentException, JSONException,
			IllegalAccessException, InvocationTargetException, ParseException {
