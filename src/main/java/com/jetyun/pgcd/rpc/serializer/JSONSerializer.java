...
import com.jetyun.pgcd.rpc.serializer.impl.ArraySerializer;
import com.jetyun.pgcd.rpc.serializer.impl.BeanSerializer;
import com.jetyun.pgcd.rpc.serializer.impl.BooleanSerializer;
import com.jetyun.pgcd.rpc.serializer.impl.DateSerializer;
import com.jetyun.pgcd.rpc.serializer.impl.DictionarySerializer;
import com.jetyun.pgcd.rpc.serializer.impl.ListSerializer;
import com.jetyun.pgcd.rpc.serializer.impl.MapSerializer;
import com.jetyun.pgcd.rpc.serializer.impl.NumberSerializer;
import com.jetyun.pgcd.rpc.serializer.impl.PrimitiveSerializer;
import com.jetyun.pgcd.rpc.serializer.impl.RawJSONArraySerializer;
import com.jetyun.pgcd.rpc.serializer.impl.RawJSONObjectSerializer;
import com.jetyun.pgcd.rpc.serializer.impl.SetSerializer;
import com.jetyun.pgcd.rpc.serializer.impl.StringSerializer;
...
public class JSONSerializer {
	...
	/**
	 * 功能说明:获取序列化器 获取的方式为先通过要转换的java类获取单独为某个java进行转换的序列化器，
	 * 在没有获取到该序列化器后会根据序列化器的canSerialize方法获取可以为某一类进行 序列化的序列化器<br>
	 * 创建者: 李祥辉<br>
